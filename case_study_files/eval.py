...
def f():
    ...
    #male_31_40_total = male_31_40_total + male_31_40_2
    ...
    #female_21_30_5 = Normal(mu=470_000, std=100)
    #female_21_30_6 = Normal(mu=400_000, std=100)
    
    #female_21_30_7 = Normal(mu=490_000, std=100)
    #female_21_30_8 = Normal(mu=330_000, std=100)
