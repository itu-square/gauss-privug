...
def f():
    ...
    male_31_40_total = male_31_40_total / 10

    #Update the condition to be the average 
    #condition("male_31_40_total", 516_000)
    ...
    male_41_50_total = male_41_50_total / 10
    ...
    male_51_60_total = male_51_60_total / 10
    ...
    total_21_30 = total_21_30 + noise_1 
    
    condition("total_21_30", 448_500)
    
    total_male = Normal(mu=0, std=0)
    total_male = total_male + male_21_30_1
    total_male = total_male + male_21_30_2
    ...
    total_male = total_male / 40
    
    total_male = total_male + noise_2
    
    #condition("total_male", 559_000)
    
    
    return male_21_30_1

    #Female 31 - 40
    #female_31_40_1 = Normal(mu=400_000, std=100)
    #female_31_40_2 = Normal(mu=450_000, std=100)
    
    #female_31_40_3 = Normal(mu=490_000, std=100)
    #female_31_40_4 = Normal(mu=480_000, std=100)
    
    #female_31_40_5 = Normal(mu=500_000, std=100)
    #female_31_40_6 = Normal(mu=550_000, std=100)
    
    #female_31_40_7 = Normal(mu=590_000, std=100)
    #female_31_40_8 = Normal(mu=350_000, std=100)
    
    #female_31_40_9 = Normal(mu=510_000, std=100)
    #female_31_40_10 = Normal(mu=360_000, std=100)

    #female_31_40_total = female_31_40_1 + female_31_40_2
    #female_31_40_total = female_31_40_total + female_31_40_3
    #female_31_40_total = female_31_40_total + female_31_40_4
    #female_31_40_total = female_31_40_total + female_31_40_5
    #female_31_40_total = female_31_40_total + female_31_40_6
    #female_31_40_total = female_31_40_total + female_31_40_7
    #female_31_40_total = female_31_40_total + female_31_40_8
    #female_31_40_total = female_31_40_total + female_31_40_9
    #female_31_40_total = female_31_40_total + female_31_40_10

    #female_31_40_total = female_31_40_total / 10
    #Update the condition to be the average 
   # condition("female_31_40_total", 506_000)


    #Female 41 - 50
    #female_41_50_1 = Normal(mu=550_000, std=100)
    #female_41_50_2 = Normal(mu=490_000, std=100)

    #female_41_50_3 = Normal(mu=520_000, std=100)
    #female_41_50_4 = Normal(mu=500_000, std=100)

    #female_41_50_5 = Normal(mu=650_000, std=100)
    #female_41_50_6 = Normal(mu=480_000, std=100)
    
    #female_41_50_7 = Normal(mu=150_000, std=100)
    #female_41_50_8 = Normal(mu=790_000, std=100)

    #female_41_50_9 = Normal(mu=510_000, std=100)
    #female_41_50_10 = Normal(mu=700_000, std=100)

    #female_41_50_total = female_41_50_1 + female_41_50_2
    #female_41_50_total = female_41_50_total + female_41_50_3
    #female_41_50_total = female_41_50_total + female_41_50_4
    #female_41_50_total = female_41_50_total + female_41_50_5
    #female_41_50_total = female_41_50_total + female_41_50_6
    #female_41_50_total = female_41_50_total + female_41_50_7
    #female_41_50_total = female_41_50_total + female_41_50_8
    #female_41_50_total = female_41_50_total + female_41_50_9
    #female_41_50_total = female_41_50_total + female_41_50_10

    #female_41_50_total = female_41_50_total / 10
    #Update the condition to be the average 
    #condition("female_41_50_total", 588_000)


    #Female 51 - 60
    #female_51_60_1 = Normal(mu=680_000, std=100)
    #female_51_60_2 = Normal(mu=670_000, std=100)
    
    #female_51_60_3 = Normal(mu=690_000, std=100)
    #female_51_60_4 = Normal(mu=700_000, std=100)
    
    #female_51_60_5 = Normal(mu=630_000, std=100)
    #female_51_60_6 = Normal(mu=570_000, std=100)

    #female_51_60_7 = Normal(mu=500_000, std=100)
    #female_51_60_8 = Normal(mu=670_000, std=100)
    
    #female_51_60_9 = Normal(mu=600_000, std=100)
    #female_51_60_10 = Normal(mu=770_000, std=100)
    
    #female_51_60_total = female_51_60_1 + female_51_60_2
    #female_51_60_total = female_51_60_total + female_51_60_3
    #female_51_60_total = female_51_60_total + female_51_60_4
    #female_51_60_total = female_51_60_total + female_51_60_5
    #female_51_60_total = female_51_60_total + female_51_60_6
    #female_51_60_total = female_51_60_total + female_51_60_7
    #female_51_60_total = female_51_60_total + female_51_60_8
    #female_51_60_total = female_51_60_total + female_51_60_9
    #female_51_60_total = female_51_60_total + female_51_60_10

    #female_51_60_total = female_51_60_total / 10
    
    #Update the condition to be the average 
    #condition("female_51_60_total", 707_000)
...
#def f():
 ...
 #   male_21_30_1 = Normal(mu=480_000, std=100)
  #  male_21_30_2 = Normal(mu=490_000, std=100)
   ...
   # condition("male_21_30_total", 980_000)


    #Male 31 - 40
    #male_31_40_1 = Normal(mu=500_000, std=100)
    #male_31_40_2 = Normal(mu=450_000, std=100)

    #male_31_40_total = male_31_40_1 + male_31_40_2

    #condition("male_31_40_total", 960_000)


    #Male 41 - 50
    #male_41_50_1 = Normal(mu=580_000, std=100)
    #male_41_50_2 = Normal(mu=570_000, std=100)

    #male_41_50_total = male_41_50_1 + male_41_50_2

    #condition("male_41_50_total", 1_140_000)


    #Male 51 - 60
    #male_51_60_1 = Normal(mu=580_000, std=100)
    #male_51_60_2 = Normal(mu=570_000, std=100)
    ...
    #Female 21 - 30
    #female_21_30_1 = Normal(mu=450_000, std=100)
    #female_21_30_2 = Normal(mu=430_000, std=100)

    #female_21_30_total = female_21_30_1 + female_21_30_2

    #condition("female_21_30_total", 880_000)
    ...
    #condition("female_31_40_total", 950_000)


    #Female 41 - 50
    #female_41_50_1 = Normal(mu=550_000, std=100)
    #female_41_50_2 = Normal(mu=400_000, std=100)

    #female_41_50_total = female_41_50_1 + female_41_50_2

    #condition("female_41_50_total", 930_000)
    ...
    #condition("female_51_60_total", 1_370_000)
    ...
    #total_female_21_30_1 = female_21_30_1 + female_21_30_2
    #total_21_30 = total_male_21_30_1 + total_female_21_30_1
    #condition("total_21_30", 1_860_000)
 ...
 #   male_21_30_1 = Normal(mu=480_000, std=100)
  #  male_21_30_2 = Normal(mu=490_000, std=100)
   ...
   # male_21_30_total = male_21_30_1 + male_21_30_2
    ...
    #Male 51 - 60
    #male_51_60_1 = Normal(mu=660_000, std=100)
    #male_51_60_2 = Normal(mu=620_000, std=100)

    #male_51_60_total = male_51_60_1 + male_51_60_2

    #condition("male_41_50_total", 1_380_000)
   ...
   # total_male = total_male + male_51_60_2
    ...
    #condition("total_male", 4_460_000)
